...
use shared::{ProducerCommand, ProducerUpdate, ProcessStatus};
use shared::messages::producer::{ProducerSyncStatus};
use crate::fixtures::{
    CommandFactory, UpdateFactory, ProducerIdFactory, MockOrchestrator
};
...
async fn test_large_message_handling() {
    ...
    let large_update = UpdateFactory::attribute_batch(
        producer_id,
        1,
        large_attributes,
        shared::types::ProviderId::OpenAI,
